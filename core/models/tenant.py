...
class Tenant(BaseModel):
    ...
    domain = models.CharField(max_length=200, unique=True, null=False, blank=False)
    image = models.ImageField(verbose_name='tenant logo image', null=False, blank=True, upload_to=get_tenant_image_path)
    description = models.TextField(max_length=1000, unique=False, null=False, blank=True, default='')
    ...
    def set_domain(self):
        self.domain = generate_random_letters(length=settings.TENANT_DOMAIN_LENGTH)
