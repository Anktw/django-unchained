...
class PasswordResetCodeView(APIView):
    ...
    def post(self,request):
        ...
        self.send_reset_code(email=reset_code.email, reset_code=reset_code.reset_code)
...
class PasswordResetView(APIView):
    ...
    def delete_password_reset_codes(self, email):
        query = models.PasswordReset.objects.filter(email=email)
        count = query.count()
        query.delete()
    ...
    def delete_failed_login_attempts(self, request, email):
        ...
        query = models.FailedLoginAttempt.objects.filter(email=email, ip_address=ip_address)
